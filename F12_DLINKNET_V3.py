...
class DinkNet34(nn.Module):
    def __init__(self, num_classes=1, num_channels=3):
        ...
        #resnet = models.load_state_dict(torch.load(os.path.join(data_folder, "resnet34-333f7ec4.pth")))
        resnet = models.resnet34(pretrained=True)
        self.firstconv = resnet.conv1
        self.firstbn = resnet.bn1
        self.firstrelu = resnet.relu
...
class DinkNet101(nn.Module):
    def __init__(self, num_classes=1):
        ...
        # pretrain_dict = torch.load('D:/Users/akagunduz/deepSegmentation/20210215_code/experiments/resnet101-5d3b4d8f.pth')
        # model = DinkNet101(num_classes=1).to(device)
        # resnet = model.load_state_dict(pretrain_dict)
